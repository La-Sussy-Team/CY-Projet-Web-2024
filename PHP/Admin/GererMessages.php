        ...
        <?php if (!empty($user_conversations)) : ?>
            <ul>
                <?php foreach ($user_conversations as $conversation) : ?>
                    ...
                    ?>
                    <div class="conversation-module" onclick="window.location='AffichageMessages.php?user_id=<?php echo $user_id ?>&other_user_id=<?php echo $other_user_id; ?>'" > 
                        <img src="../../../Assets/Client/ProfileImage/<?php echo $image_other_user; ?>" alt="Profile Image">
                        <li><a href="AffichageMessages.php?user_id=<?php echo $user_id ?>&other_user_id=<?php echo $other_user_id; ?>"><?php echo htmlspecialchars($other_username); ?></a></li>
